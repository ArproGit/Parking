...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Recuperar Contraseña como Empleado</p>
      <p class="login-box-msg">Si su correo existe y se encuentra en nuestro registro, le enviaremos un correo con los pasos necesarios, no olvide revisar su carpeta de spam.</p>


      <form method="post" action="ingresar-empleado/intentando-recuperar-clave" id="demo-form">
        <input type="hidden" name="csrf_token" value="<?= $token_1 ?>">
        <div class="input-group mb-3">
          <input type="email" name="email_recuperar" id="email_recuperar" class="form-control" placeholder="Ingrese su Correo como Empleado">
        ...
        <div class="row pt-3">
          ...
          <div class="col-12 d-grid">
            <button  
              ...
              data-action='submit' type="submit" class="g-recaptcha btn btn-primary btn-block">ENVIAR</button>
          </div>
          <!-- /.col -->
          ...
          <div class="text-center mt-4" style="margin: 0 auto;">
            ...
            <p>¿Recordaste tu contraseña? <br><strong><a href="<?= URL_FRONT ?>" class="text-[#11126A] font-bold">Iniciar Sesión</a></strong></p>
          </div>
        </div>
      </form>
